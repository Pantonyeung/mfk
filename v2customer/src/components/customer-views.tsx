...
export function CheckoutView({cart,quote,checkout,setCheckout,paymentChannels,pending,actionState,submitProbe,fallbackAvailable,onFallback,onSubmit,onReadback,onBack,onRepair,onPaymentEvidence}:{
  cart:readonly CustomerCartLine[];quote:CustomerQuoteSnapshot|null;checkout:CustomerCheckoutDraft;setCheckout:(v:CustomerCheckoutDraft)=>void;paymentChannels:NonNullable<CustomerReadModelSnapshot['paymentChannels']>;pending:CustomerPendingIntent|null;actionState:ActionState;submitProbe:Readonly<{attempt:number;total:number}>|null;fallbackAvailable:boolean;onFallback:()=>void;onSubmit:()=>void;onReadback:(intent:CustomerPendingIntent)=>void;onBack:()=>void;onRepair:()=>void;onPaymentEvidence:(file:File)=>void;
}){
