...
export const ADMIN_CAPABILITY_GROUPS:readonly AdminCapabilityGroup[]=[
  ...
  {id:'menu',label:'菜單',capabilities:[
    ...
    c('publish-center','Pending Changes／發布','/admin/publish','READY','ADMIN_CONFIG','草稿 → 檢查內容 → 確認影響 → 發布 → 門店回傳 → 還原流程。'),
  ...
  {id:'store',label:'門店',capabilities:[
    ...
    c('inventory','庫存統計','/admin/operations/inventory','P1','REPORTING','Inventory Lite 保留，P1；目前唔用 inventory 阻交易。'),
  ...
  {id:'members',label:'會員',capabilities:[
    c('members','顧客資料','/admin/members/customer360','P1','REPORTING','CRM Lite 保留，P1。'),
